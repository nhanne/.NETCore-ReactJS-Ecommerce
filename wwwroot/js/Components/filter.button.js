...
export default function Button() {
    ...
    const handlePage = (e, skipPage) => {
        if (skipPage > 0 && skipPage < parseInt(context.totalPages) + 1) {
    ...
    return (
        <div className="home-filter__page">
            <span className="home-filter__page-num">
                <span className="home-filter__page-current">{context.page}</span> / {context.totalPages}
            </span>
            <div className="home-filter__page-control">
                ...
                <a onClick={(event) => handlePage(event, context.page + 1)}
                    className={`home-filter__page-btn home-filter__page-btn--right ${context.page == context.totalPages ? 'home-filter__page-btn--disabled' : ''}`}
                >
